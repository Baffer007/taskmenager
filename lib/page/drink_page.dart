...
import 'package:salvia/list/drink.dart';
import 'package:salvia/list/drink_last.dart';
...
class DrinksPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: InkWell(
          onTap: (){
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => DrinkLastPage()));
